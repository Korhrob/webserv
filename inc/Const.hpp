...
const std::vector<std::string>	VALID_DIRECTIVES { "listen", "host", "server_name", "index", "root", "methods", "cgi", "client_max_body_size", "access_log", "error_log", "worker_connections", "client_max_body_size", "error_page", "allow_methods", "autoindex", "cgi_path", "cgi_ext", "return", "alias" };