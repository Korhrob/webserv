...
const std::vector<std::string>	VALID_DIRECTIVES { "listen", "server_name", "index", "root", "methods", "cgi", "uploadFolder", "client_max_body_size", "access_log", "error_log", "worker_connections" };